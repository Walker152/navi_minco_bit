...
void TransformUtils::publishStaticTransform()
{
    ...
    // RCLCPP_INFO(this->get_logger(), "Published static transform from base_link to gimbal");
}
                                            ...
                                            geometry_msgs::msg::Pose& output_pose)
{
    try
    {
        ...
        transform_stamped = tf_buffer_->lookupTransform(
            "map", "gimbal", tf2::TimePointZero, tf2::durationFromSec(1.0));
