 ...
 */
real_t SolutionAnalysis::getKktViolation(
  QProblemB * const qp, real_t * const maxStat, real_t * const maxFeas, real_t * const maxCmpl) const
{
  int_t i;
  int_t nV = qp->getNV();
  ...
  returnValue returnvalue = REFER_NAMESPACE_QPOASES getKktViolation(
    nV, H_ptr, qp->g, qp->lb, qp->ub, qp->x, qp->y, stat, feas, cmpl, workingSetB, hasIdentityHessian);
  if (workingSetB != 0)
    delete[] workingSetB;
 ...
 */
real_t SolutionAnalysis::getKktViolation(
  QProblem * const qp, real_t * const maxStat, real_t * const maxFeas, real_t * const maxCmpl) const
{
  int_t i;
  int_t nV = qp->getNV();
  int_t nC = qp->getNC();
 ...
 */
real_t SolutionAnalysis::getKktViolation(
  SQProblem * const qp, real_t * const maxStat, real_t * const maxFeas, real_t * const maxCmpl) const
{
 ...
 */
returnValue SolutionAnalysis::getVarianceCovariance(
  QProblemB * const qp, const real_t * const g_b_bA_VAR, real_t * const Primal_Dual_VAR) const
{
 ...
 */
returnValue SolutionAnalysis::getVarianceCovariance(
  QProblem * qp, const real_t * const g_b_bA_VAR, real_t * const Primal_Dual_VAR) const
{
  ...
  for (run3 = 0; run3 < dim; run3++) {
    ...
    returnvalue = qp->determineStepDirection(delta_g_cov,
      delta_lbA_cov,
      delta_ubA_cov,
      delta_lb_cov,
      delta_ub_cov,
 ...
 */
returnValue SolutionAnalysis::getVarianceCovariance(
  SQProblem * const qp, const real_t * const g_b_bA_VAR, real_t * const Primal_Dual_VAR) const
{
...
{
  printf("checkCurvatureOnStronglyActiveConstraints( SQProblem* qp ) not yet implemented for standard "
         "qpOASES!\n");
