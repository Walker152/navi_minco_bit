...
public:
  ...
  /**
   * @class minco_planner::smac::Node2D::Coordinates
  ...
  /**
   * @brief A destructor for minco_planner::smac::Node2D
   */
  ~Node2D();
  ...
  {
    return Coordinates(index % _size_x, index / _size_x);
  }
...
#endif  // MINCO_PLANNER__SMAC_SEARCH__NODE_2D_HPP_
