    ...
    class ROGMapROS : public ROGMap {
        ...
        struct VisualizeMap {
            rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr
                ...
                occ_inf_pub, unknown_inf_pub, frontier_pub, esdf_pub, elev_pub;
        ...
        void vizCallback() {
            ...
            if ((box_max - box_min).minCoeff() <= 0) {
                ...
                // std::cout << YELLOW << " -- [ROGMap] Visualization range is too small around robot. Fallback to full local map." << RESET << std::endl;
            ...
            if (cfg_.esdf_en) {
                ...
                //         RCLCPP_WARN(nh_->get_logger(), "ESDF enabled but no subscriber found for topic 'rog_map/esdf'.");
                //         last_print_t = cur_t;
                //     }
                // }
