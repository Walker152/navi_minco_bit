  ...
  Callback callback)
{
  ...
  if (cfg.viz_occupied_enable) {
    pubs_.occ_pub =
      createPublisher<sensor_msgs::msg::PointCloud2>(parameters, topics, cfg.viz_occupied_topic, qos);
  }
  if (cfg.viz_unknown_enable) {
    pubs_.unknown_pub =
      createPublisher<sensor_msgs::msg::PointCloud2>(parameters, topics, cfg.viz_unknown_topic, qos);
  }
  ...
  if (cfg.viz_frontier_enable && cfg.frontier_extraction_en) {
    pubs_.frontier_pub =
      createPublisher<sensor_msgs::msg::PointCloud2>(parameters, topics, cfg.viz_frontier_topic, qos);
  }
  if (cfg.esdf_en) {
    pubs_.esdf_pub =
  ...
  if (cfg.layer_en && cfg.viz_layer_value_enable) {
    pubs_.layer_value_pub =
      createPublisher<nav_msgs::msg::OccupancyGrid>(parameters, topics, cfg.viz_layer_value_topic, qos);
  }
  if (cfg.layer_en && cfg.viz_layer_type_enable) {
    pubs_.layer_type_pub =
      createPublisher<nav_msgs::msg::OccupancyGrid>(parameters, topics, cfg.viz_layer_type_topic, qos);
  }
  ...
  if (cfg.layer_en && cfg.viz_layer_height_enable) {
    pubs_.layer_height_pub =
      createPublisher<sensor_msgs::msg::PointCloud2>(parameters, topics, cfg.viz_layer_height_topic, qos);
  }
  if (cfg.viz_field_enable) {
    pubs_.field_pub =
      createPublisher<sensor_msgs::msg::PointCloud2>(parameters, topics, cfg.viz_field_topic, qos);
  }
  if (cfg.viz_decay_cells_enable) {
    pubs_.decay_cells_pub =
      createPublisher<sensor_msgs::msg::PointCloud2>(parameters, topics, cfg.viz_decay_cells_topic, qos);
  }
  if (cfg.performance_enable && cfg.performance_publish_enable) {
    pubs_.performance_pub =
      createPublisher<std_msgs::msg::String>(parameters, topics, cfg.performance_topic, qos);
  }
