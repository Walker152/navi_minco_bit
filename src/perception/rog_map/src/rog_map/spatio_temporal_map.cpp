...
void SpatioTemporalMap::initSpatioTemporalMap(
  const Vec3i & half_map_size_i, const double & resolution, const STVLConfig & cfg)
{
  cfg_ = cfg;
...
bool SpatioTemporalMap::isInMid360Frustum(
  const super_utils::Vec3f & pt_world, const super_utils::Vec3f & sensor_pos) const
{
...
void SpatioTemporalMap::applyTemporalDecay(
  ProbMap::Ptr prob_map, const super_utils::RobotState & robot_state, double current_time)
{
